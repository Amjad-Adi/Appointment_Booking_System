...
import {TABLE_NAME,COLUMN_ID, COLUMN_UUID ,COLUMN_NAME,COLUMN_LOCATION_ON_MAP,COLUMN_CREATED_AT_UTC,COLUMN_UPDATED_AT_UTC} from "../databases/contract/location.contract"
