...
import {COLUMN_ID, COLUMN_UUID, COLUMN_NAME, COLUMN_EMAIL, COLUMN_PHONE_NUMBER, COLUMN_BIO, COLUMN_LOCATION_ID, COLUMN_PROFILE_PICTURE_PATH, COLUMN_CREATED_AT_UTC, COLUMN_UPDATED_AT_UTC, COLUMN_STATUS, TABLE_NAME, ALIAS, ALIAS_COLUMN_PHONE_NUMBER, ALIAS_COLUMN_PROFILE_PICTURE_PATH, ALIAS_COLUMN_CREATED_AT_UTC,ALIAS_COLUMN_UPDATED_AT_UTC,} from "../databases/contract/organization.contract"
import {
    ...
    ALIAS_COLUMN_LOCATION_UUID as LOCATION_ALIAS_COLUMN_UUID,
    ALIAS_COLUMN_LOCATION_NAME as LOCATION_ALIAS_COLUMN_NAME,
    COLUMN_UUID as LOCATION_COLUMN_UUID,
    ALIAS_COLUMN_LOCATION_NAME
} from "../databases/contract/location.contract"
import {QueryResult} from "pg";
import {create as createLocation} from "./location.repository"
