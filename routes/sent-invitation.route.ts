...
sendInvitationRouter.route("/:invitationUuid")
    ...
    .patch(authenticateToken,authorize(UPDATE_ORGANIZATION_INVITATIONS),validateParameter(validateUuid,"invitationUuid"),validateBody(updateServiceSchema),handleUpdateOrganizationInvitation)